...
type MockPostService struct {
	...
	FindByUserIDFunc func(userID, p domain.Pagination) ([]domain.Post, error)
}
...
func (s *MockPostService) GetPostsByUser(userID, p domain.Pagination) ([]domain.Post, error) {
	return s.FindByUserIDFunc(userID, p)
}
